...
class IceCreamStand(Restaurant):
    def __init__(self,restaurant_name,cuisine_type,flavors='yuanwei'):
        super().__init__(restaurant_name,cuisine_type)
        self.flavors = flavors
    
    def icecream_flavors(self):
        print(f"This icecream flavors is {self.flavors}\n")

icecream = IceCreamStand('Jinitaimei','Obaby','mocha')
